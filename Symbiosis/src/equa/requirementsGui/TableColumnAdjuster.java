...
//
//            if (!tcm.getColumn(i).getHeaderValue().toString().equalsIgnoreCase("Risk") && !tcm.getColumn(i).getHeaderValue().toString().equalsIgnoreCase("Realized")) {
//                adjustColumn(i);
//            } else if (!tcm.getColumn(i).getHeaderValue().toString().equalsIgnoreCase("Realized")) {
