...
public class FileUtils {
    ...
    public static void saveGeneratedIntoFolder(String classname, ArrayList<String> generated, String language, String... folder) {
        ...
        String currentDirName = folder.length > 0 ? folder[0] : project.getFile().getAbsolutePath();
        ...
        currentDirName = currentDirName + File.separatorChar + project.getName();
