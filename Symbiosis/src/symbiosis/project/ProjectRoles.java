...
import symbiosis.meta.IncorrectNameException;
...
public class ProjectRoles implements ComboBoxModel<ProjectRole>, Serializable {
    ...
    public void changeId(ProjectRole projectrole, String name, String role) throws symbiosis.meta.DuplicateException, IncorrectNameException {
